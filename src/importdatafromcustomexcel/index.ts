...
export class importdatafromcustomexcel implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	public updateView(context: ComponentFramework.Context<IInputs>): void
	{
		...
		console.log(context.parameters.ResetControl.raw);
		if(context.parameters.ResetControl.raw == true)
		{
			this._excelUploadinput.value = '';
			this._paragraphinput.innerHTML = '';
	...
	{
		return {
			Output: this._paragraphinput.innerHTML,
			ResetControl:false
		};
	}
